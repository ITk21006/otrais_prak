...
#The API key and URL 
nasa_api_key = "c1oxNu91jYVOdki9wo04OyDNhgkpLBIMnbfV9cU8"
...
#Prints NASA response
print("Response status code: " + str(r.status_code))
print("Response headers: " + str(r.headers))
print("Response content: " + str(r.text))

#Counts safe and hazardous asteroids
...
#Displays todays asteroid count
		print("Asteroid count today: " + str(ast_count))
#gathers info about asteroids
		if ast_count > 0:
...
#i honestly dont understand python
